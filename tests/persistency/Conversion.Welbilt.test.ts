...
describe('Conversion for Welbilt TMTs for TC6000L to K08', () => {
  const dataDir = path.join(__dirname, '..', 'data', 'welbilt-conversion-source');
  const dumpDir = path.join(__dirname, '..', 'dump', 'welbilt-conversion-source');
  ...
  const lttReplacements: Record<string, string> = {
    'T2D-5515': 'SS010MD0-N2SF-20-2:TC43-FW-4000-0-99999-3-1.4301-1-0-1-0-170',
    'T2D-5516': 'SS015MD0-N2S0-20-2:TC43-FW-4000-0-99999-3-1.4301-1-0-1-0-170',
  };
  const ruleReplacements: Record<string, string> = {
    'T2D-5515-5': 'SS010MD0-N2SF-20-2:TC43-FW-4000-4000-0-99999-3-1.4301-1-0-1-0-170:1',
    'T2D-5516-5': 'SS015MD0-N2S0-20-2:TC43-FW-4000-4000-0-99999-3-1.4301-1-0-1-0-170:1',
  };
